          ...
          {CLUSTERS.map(({ letter, name, desc, accent }, i) => (
            <div
              ...
              style={{
                ...
                borderBottom: i === CLUSTERS.length - 1 ? `1px solid ${color.line}` : 'none',
                paddingLeft: accent ? 'clamp(16px,2vw,24px)' : 0,
                borderLeft: accent ? `3px solid ${color.brand}` : 'none',
                marginLeft: accent ? 0 : 3,
