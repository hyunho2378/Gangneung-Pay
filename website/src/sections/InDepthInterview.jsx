    ...
    >
      <div style={{ maxWidth: layout.container, margin: '0 auto' }}>
        ...
        <div ref={execRef} style={{
          ...
          <KeyBox title="핵심 결론 (One-Liner)">
            <p style={{
              ...
              강릉페이는 현재 10% 캐시백이라는 단일 동인에 의해 생명을 유지하는 '혜택 의존형 충전 도구'입니다. 앱은 결제 수단이 아니라 캐시백 잔액 확인 창구로 기능 축소되어 있으며, 이 구조가 유지되는 한 어떠한 기능 추가도 근본적 성장을 담보하지 못합니다.
            </p>
          </KeyBox>
        ...
        <div ref={step2Ref} style={{
          ...
          <Body>
            사용자들이 '불편하다'고 발화한 지점을 액면 그대로 받아들이는 것은 리서치의 실패입니다. 불편 발화 너머에 있는 심리적 원형(Fear, Anxiety, Habit, Pride)을 파악해야 진짜 개선 방향이 보입니다.
          </Body>
          ...
          <div style={{
            ...
            {[
              {
                num: '2-1',
                title: '계산대 민망함 증후군 (Social Anxiety at POS)',
                line: '잔액 부족 또는 로딩 지연으로 인해 계산대 앞에서 시간이 지체되는 경험은 단순한 기술적 불편이 아닙니다.',
              },
              {
                num: '2-2',
                title: '충전의 심리적 비용 (Cognitive Load of Top-Up)',
                line: "선불 충전 구조는 사용자에게 '관리 의무'를 부과합니다.",
              },
              {
                num: '2-3',
                title: '고착된 실물 카드 습관 (Entrenched Physical Card Habit)',
          ...
          {/* 2-1 아코디언 */}
          <Accordion label="2-1 계산대 민망함 증후군 상세">
            ...
            <Body noMargin>
              계산대 앞 민망함은 앱의 성능 문제이기 이전에 '잔액 가시성' 문제입니다. 사용자가 언제든 현재 잔액을 즉각 인지할 수 있는 위젯 또는 홈 화면 뱃지가 없는 구조가 이 불안을 구조화합니다. 잔액이 보이지 않으면 사용자는 항상 불안하고, 불안한 사용자는 결국 가장 확실한 수단(실물 카드)으로 이탈합니다.
            </Body>
          </Accordion>

          {/* 2-2 아코디언 */}
          <Accordion label="2-2 충전의 심리적 비용 상세">
            <p style={eyebrowSm}>발화 데이터</p>
            <Quote lines={[
          ...
          {/* 2-3 아코디언 */}
          <Accordion label="2-3 고착된 실물 카드 습관 상세">
            <p style={eyebrowSm}>발화 데이터</p>
            <Quote lines={[
        ...
        <div ref={step4Ref} style={{
          ...
          <Accordion label="구조적 결함 3 상세">
            ...
            />
            <Body noMargin>
              편의점 소상공인의 발화에서 충격적인 사실이 드러났습니다. 하루에 10명 중 5명이 '강릉페이 되나요?'라고 물어보는데, 그 이유가 편의점은 강릉페이가 안 된다는 오해 때문이라는 것입니다. 즉, 실제 가맹점에서조차 고객에게 강릉페이를 이용시키지 못하는 정보 단절이 현재 진행 중입니다. 가맹점 지도가 있어도 가맹점주가 자기 가게가 지도에 표시되는 줄 모른다면, 그 지도는 가치가 없습니다.
            </Body>
          </Accordion>
        </div>
