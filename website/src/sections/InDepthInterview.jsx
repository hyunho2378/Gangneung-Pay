      ...
      <div style={{ maxWidth: layout.container, margin: '0 auto' }}>
        ...
        <div ref={step2Ref} style={{
          ...
          <Accordion label="2-1 계산대 민망함 증후군 상세">
            ...
            <Body noMargin>
              계산대 앞 민망함은 앱의 성능 문제이기 이전에 '잔액 가시성' 문제입니다. 사용자가 언제든 현재 잔액을 즉각 인지할 수 있는 위젯 또는 홈 화면 뱃지가 없는 구조가 이 불안을 만들어냅니다. 잔액이 보이지 않으면 사용자는 항상 불안하고, 불안한 사용자는 결국 가장 확실한 수단(실물 카드)으로 이탈합니다.
            </Body>
          </Accordion>
